...
# 	return(data.frame(matrix(unlist(exif_data), nrow=length(exif_data), byrow=T)))
# }
...
# # trying to batch process the EXIF data (NOT WORKING YET)
# # test <- system2("exiftool",args=paste("-r ","path"," FileType -csv"), stdout=paste("exif",path,".csv"))
# # system2("exiftool", args=paste("-FileType -csv -t -r ",path), stdout="photodata.csv")

# # Trying to extract metadata other than EXIF
# exif_data <- system2("exiftool", args="-a -u -scanForXMP -U -ee 06160001.JPG", photo, stdout=T)
# (exif_data)
# exif_data <- system2("exiftool", args="-a -u -scanForXMP -U -ee 06160003.JPG", photo, stdout=T)
# (exif_data)
# exif_data <- system2("exiftool", args="-a -u -scanForXMP -U -ee 06160004.JPG", photo, stdout=T)
# (exif_data)
# exif_data <- system2("exiftool", args="-icc_profile -b -w icc 06160001.JPG", photo, stdout=T)
# (exif_data)
# exif_data <- system2("exiftool", args="-xmp -b 06160001.JPG.jpg", photo, stdout=T)
# (exif_data)
...
# # use -v for verbose - can see SensingMethod!!! under APP1 - IFD0 - ExifIFD
# # Update - not actually what I want...
# exif_data <- system2("exiftool", args="-b -a -u -v -f -G -F -scanForXMP -U -ee 06160003.JPG", photo, stdout=T)
# View(exif_data)

# exif_data2 <- system2("exiftool", args="-b -a -u -v3 -f -G -F -scanForXMP -U -ee 06160004.JPG", photo, stdout=T)
# View(exif_data2)

# exif_data3 <- system2("exiftool", args="-b -a -u -v3 -f -G -F -scanForXMP -U -ee 06160007.JPG", photo, stdout=T)
# View(exif_data3)


# exif_data3 <- system2("exiftool", args="-DateTimeOriginal 06160007.JPG", photo, stdout=T)
# View(exif_data3)
